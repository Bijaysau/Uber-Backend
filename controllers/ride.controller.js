...
module.exports.createRide = async (req, res) => {
  ...
  const { userId, pickup, destination, vehicleType, mobile } = req.body;
...
module.exports.declineRide = async (req, res) => {
  ...
  try {
    ...
    sendMessageToSocketId(ride.user.socketId, {
      event: "ride-declined",
      data: { message: "Captain declined the ride. Searching again..." },
    });

    // Optionally: Find next nearby captain & notify them
    // (Can reuse your previous code here)
